...
**Son yayın:** `20260911.02` (2026-09-11, `./surum-yayinla.sh` ile) —
eklentide Tab tamamlama (JBPopup + CustomShortcutSet), agy headless izin
reddi tespiti, renkli adım süreleri, koşu öncesi önbellek sorusu. İlk yayın
`20260910.03`'te Marketplace API'si `approve: false` diyordu (moderasyon);
onay durumu her yayında `/api/plugins/34196/updates` ile kontrol edilmeli.
Yayın öncesi CHANGELOG "Unreleased/Yayınlanmamış" başlığı etikete
çevriliyor (betik bunu kendisi yapmıyor).
